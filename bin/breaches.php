...
if ($argc === 1) {
    echo "Error: An email address argument is required (e.g. ./breaches.php 'email@example.com')" . \PHP_EOL;
    exit(1);
}

if ($argc > 2) {
    echo "Warning: This application requires a single argument (e.g. ./breaches.php 'email@example.com'). Additional arguments will be ignored." . \PHP_EOL;
}
...
foreach ((new BreachedAccount($guzzle, $apiKey))->breaches($argv[1]) as $breach) {
