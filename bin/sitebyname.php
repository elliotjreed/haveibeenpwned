...
if ($argc === 1) {
    echo "Error: A site name argument is required (e.g. ./sitesbyname.php 'Adobe')" . \PHP_EOL;
    exit(1);
}

if ($argc > 2) {
    echo "Warning: This application requires a single argument (e.g. ./sitesbyname.php 'Adobe'). Additional arguments will be ignored." . \PHP_EOL;
}
...
$breach = (new Breaches($guzzle, $apiKey))->byName($argv[1]);
